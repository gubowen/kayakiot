module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    serverAutoGrunt: true, //是否需要服务器自动打包
    ...
    watch: {
      ...
      //src/项目名 目录下的.jq
      scripts: {
        files: ['src/kayakiot/pages/**/*.vue', 'src/kayakiot/**/*.jq'],
        options: {
          spawn: false
        }
      },
    ...
    copy: {
      ...
      fixJs: {
        ...
        dest: 'dist',
        options: {
          process: function (content, srcpath) { //请使用当前项目名称替换以下 kayakiot
            var result = content.replace(/kayakiot\/src\/kayakiot/g, 'kayakiot/dist/kayakiot');
