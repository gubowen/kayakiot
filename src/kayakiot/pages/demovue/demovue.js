...
define('kayakiot/pages/demovue/demovue', function (require, exports, module) {
...
var page;
  ...
  page = VuePage({
    ...
    staticRenderFns: {}, source: ['kayakiot/pages/demovue/demovue.tpl', 'kayakiot/pages/demovue/demovue.css'],
    el: 'kayakiot-pages-demovue',
    //这里必须 使用一个方法返回给data
    data: function data() {
      return {
