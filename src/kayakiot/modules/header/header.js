(function () {
    ...
    define('kayakiot/modules/header/header', function (require, exports, module) {
        require('kayakiot/modules/header/header.css');
        require('kayakiot/modules/header/header.tpl');
